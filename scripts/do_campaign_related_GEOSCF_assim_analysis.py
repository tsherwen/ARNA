#!/usr/bin/python
"""
Driver for analysis of GEOS-CF assimilation output analysis pre/post ARNA
"""
import arna as ar
...
def main():
    """
    Main driver for GEOS-CF assimilation analysis for the ARNA campaign
    """
    # Get the assimilation data
#    download_GEOSCF_assim_data()
    # Do analysis for GEOS-CF
#    do_analysis_of_assimilation_output_JUST_GEOSCF()
...
#        years = (2019, )    # For testing.
        ...
        for year in years:
            ...
            loc_str = '{}/ARNA*{}_0*REGRID*.nc'
            files2use = glob.glob(loc_str.format(folder2use, year))
            files2use = list(sorted(files2use))
            # Open all the files as a single dataset
            ...
            folder_str = '{}/GEOS_CF/ARNA/assim/plots_with_GEOS5/alt_slice/'
...
#        years = (2018, )    # For testing.
        ...
        for year in years:
            ...
            ds.lev.attrs = attrs
            # Plot and then save together
            folder_str = '{}/GEOS_CF/ARNA/assim/plots_with_GEOS5/lon_slice/'
            folder4plots = folder_str.format(NASA_data)
            # GEOS-CF
